...
df <- file.path("../../4.processing_profiled_features/data/preprocessed_data/live_cell_pyroptosis_wave1_sc_first_time_norm_fs_subset.parquet")
...
cell_counts <- df %>%
  ...
  summarise(cell_count = sum(Metadata_number_of_singlecells))

...
TOTAL_FILES_EXPECTED = WELLS * FOVS * TIMEPOINTS
...
target_dir = pathlib.Path(
    os.path.expanduser(
        "~/mnt/bandicoot/live_cell_timelapse_pyroptosis_project_data/processed_data/4.extracted_features/plate_2"
    )
)
...
time_estimation_for_total_files = (
    TOTAL_FILES_EXPECTED - last_seg_file_count
) / rate  # seconds
...
print(
    f"Finished {last_seg_file_count} files out of {TOTAL_FILES_EXPECTED} expected files."
)
print(
